...
PATH_TO_MITSUBA2 = "D:\heqifeng\mitsuba2\dist\mitsuba.exe"  # mitsuba exectuable
...
<scene version="0.5.0">
    ...
    <sensor type="perspective">
        ...
        <transform name="toWorld">
            ...
            <lookat origin="1.6,1.6,1.6" target="0,0,-0.2" up="0,0,1"/>
        </transform>
...
"""
    <shape type="sphere">
        <float name="radius" value="0.0075"/>
        <transform name="toWorld">
            <translate x="{}" y="{}" z="{}"/>
            <scale value="0.7"/>
        </transform>
...
if __name__ == '__main__':
    visual_data_dir = "D:/heqifeng/Essay Writing/VisualSelect"
    ply_files = []
    for root, dirs, files in os.walk(visual_data_dir, topdown=False):
        if root.endswith('Table'):
            for name in files:
